<?php 
	...
	$conn = mysqli_connect('localhost', 'bhargavi', 'mysqlpwd123', 'bloodbank');
  	...
  	if(isset($_POST['submit'])){
  		...
  		$query_insert = " CALL addBloodBank('$bbname', '$state', '$city') ";
...
<div class="container size">
	<div class="row">
		<div class="col-md-6 offset-md-3 form-container">
				...
				<form class="form-group" action="A_add_bloodbank.php" method="post">
					<div class="form-group">
						<label for="bbname">Name:</label>
						<input type="text" name="bbname" id="bbname" placeholder="Blood Bank Name" required pattern="[A-Za-z/\s]+" title="Only lower and upper case" class="form-control">
					</div><!--bb name-->
					<div class="form-group">
