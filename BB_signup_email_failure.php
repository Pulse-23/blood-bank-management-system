...
<div class="container size">
	<h4>This email-id already exits! Please try with another email-id</h4>
	<div class="row">
		<div class="col-md-6 offset-md-3 form-container">
          ...
          <!-- Error Messages -->
				...
				<form class="form-group" action="BB_signin.php" method="post">
              ...
              <select class="form-control demo-default" name="bloodbank" id="bloodbank" required>
              	<option value="">----------Chose the blood bank you represent----------</option>
